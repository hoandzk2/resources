...
(() => {
    ...
    QBHud.UpdateHud = function(data) {
        ...
        // Progress(data.shower, ".shower");
        // if (data.shower <= 95) {
        //     $('.hshower').fadeIn(3000);
        // }
        // if (data.shower >= 96) {
        //     $('.hshower').fadeOut(3000);
        // }
        // if (data.shower <= 45) {
        //     $('.shsh').css("stroke", "red");
        // } else {
        //     $('.shsh').css("stroke", "#3467d4");
        // }


        // Progress(data.pee, ".pee");
        // if (data.pee <= 95) {
        //     $('.hpee').fadeIn(3000);
        // }
        // if (data.pee >= 96) {
        ...
        // }
        // if (data.pee <= 45) {
        //     $('.peepee').css("stroke", "red");
        // } else {
        //     $('.peepee').css("stroke", "#f0932b");
        // }

        // Progress(data.poop, ".poop");
        // if (data.poop <= 95) {
        //     $('.hpoop').fadeIn(3000);
        // }
        // if (data.poop >= 96) {
        ...
        // }
        // if (data.poop <= 45) {
        //     $('.pooppoop').css("stroke", "red");
        // } else {
        //     $('.pooppoop').css("stroke", "#f0932b");
        // }
